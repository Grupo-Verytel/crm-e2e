    ...
    <div className="space-y-4">
      <div className="flex gap-2 overflow-x-auto pb-1">
        {contacts.map((contact, index) => {
          ...
          return (
            <button
              ...
              className={[
                'flex min-w-[7.5rem] shrink-0 flex-col items-center gap-2 rounded border px-3 py-3 text-center transition-colors',
                isSelected
        ...
        <button
          type="button"
          onClick={onAdd}
          className="flex min-w-[7.5rem] shrink-0 flex-col items-center justify-center gap-2 rounded border border-dashed border-border bg-bg px-3 py-3 text-center transition-colors hover:border-accent hover:bg-surface"
