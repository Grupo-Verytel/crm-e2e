    ...
    <fieldset className="space-y-3">
      ...
      {contacts.map((contacto, index) => (
        ...
        >
          ...
          <div>
            <label className={labelClass} htmlFor={`cita-contacto-nombre-${index}`}>
              Nombre
            </label>
            <input
              id={`cita-contacto-nombre-${index}`}
          ...
          <div>
            <label className={labelClass} htmlFor={`cita-contacto-email-${index}`}>
              Correo
            </label>
            <input
              id={`cita-contacto-email-${index}`}
              type="email"
          ...
          <div>
            <label
              ...
              htmlFor={`cita-contacto-telefono-${index}`}
            >
              Teléfono
            </label>
            <input
              id={`cita-contacto-telefono-${index}`}
              type="tel"
