...
import { OUV_ZONAS, OUV_ZONA_RIBBON_LABEL, type OuvZona } from '../lib/ouv-vocab';
...
/** Days per zone — placeholder until zone history exists in API. */
function daysInZone(_ouv: Ouv, _zona: OuvZona): number {
  return 0;
}
          ...
          return (
            ...
            >
              <span className="whitespace-nowrap">
                {daysInZone(ouv, zona)} días · {OUV_ZONA_RIBBON_LABEL[zona]}
              </span>
            </li>
          );
        })}
