...
import { weekDayLabels, type BusyBlock } from '../lib/kickoff-scheduling';
...
type Props = {
  weekAnchor: Date;
  /** Bloques ocupados reales (Microsoft Graph) + el espacio propuesto. */
  blocks: BusyBlock[];
      ...
      <div className="mb-3 flex flex-wrap items-start justify-between gap-2">
        <div>
          <p className="text-xs font-bold text-muted">
            Disponibilidad (lun–vie) — calendarios de Microsoft 365 y salas
            Verytel
          </p>
          <p className="mt-1 text-xs text-muted">
            {loading
              ? 'Consultando calendarios en Microsoft Graph…'
