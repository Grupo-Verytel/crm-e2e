...
export const DEMO_VENTAS_GANADAS: VentaGanadaRecord[] = [
  {
    ...
    datosBase: {
      ...
      unionesTemporales: [
        { id: 'me-241-ut', nombre: 'UT Perimetral Caribe', participacionPct: 60, empresa: 'UT' },
        { id: 'me-241-vt', nombre: 'Verytel S.A.', participacionPct: 40, empresa: 'Verytel' },
      ],
  ...
  },
  {
    ...
    datosBase: {
      ...
      unionesTemporales: [
        { id: 'me-245-fr', nombre: 'Frisson S.A.S.', participacionPct: 55, empresa: 'Frisson' },
        { id: 'me-245-vt', nombre: 'Verytel S.A.', participacionPct: 45, empresa: 'Verytel' },
      ],
  ...
  },
  {
    ...
    datosBase: {
      ...
      unionesTemporales: [{ id: 'me-solo-a', nombre: 'Verytel S.A.', participacionPct: 100, empresa: 'Verytel' }],
...
export function createVentaFromOuvApi(ouv: {
  ...
  return {
    ...
    datosBase: {
      ...
      recurrente: false,
      empresasEjecutoras: ['Verytel'],
      unionesTemporales: [{ id: 'me-solo-b', nombre: 'Verytel S.A.', participacionPct: 100, empresa: 'Verytel' }],
      directorProyectoId: null,
      directorProyectoNombre: null,
      tipoVenta: 'VentaDirecta',
      centroCostos: '',
