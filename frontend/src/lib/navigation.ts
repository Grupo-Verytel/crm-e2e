...
export type NavItem = {
  ...
  // CASL subjects that gate this module. Qualification uses Sql (independent of OUV).
  subjects: string[];
};
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'qualification',         label: 'Calificación',          path: '/qualification', icon: Filter,        group: 'commercial', subjects: ['Sql'] },
