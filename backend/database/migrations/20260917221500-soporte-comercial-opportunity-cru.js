...
/**
 * SoporteComercial was seeded with Opportunity `read` only (old seeder snapshot).
 * Assigning SQLs is `POST .../assign` gated by CASL `update Opportunity`.
 * spec-auth §3.1 and role-permissions.js matrix: Soporte = CRU on opportunities.
 */

const ROLE_NAME = 'SoporteComercial';
const RULES = [
